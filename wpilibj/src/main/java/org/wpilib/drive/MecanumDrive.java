 ...
 * {@link #setDeadband}.
 *
 * <p>{@link MotorSafety} is enabled by default. The driveCartesian or drivePolar methods should be
 * called periodically to avoid Motor Safety timeouts.
 */
public class MecanumDrive extends DriveBase implements Sendable, AutoCloseable {
