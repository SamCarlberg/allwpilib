 ...
 * odometry pose. Teams can use {@link Field2d} to visualize their robot on the Sim GUI's field.
 *
...
public class DifferentialDrivetrainSim {
   ...
   *     created with {@link LinearSystemId#createDrivetrainVelocitySystem(DCMotor, double, double,
   *     double, double, double)} or {@link LinearSystemId#identifyDrivetrainSystem(double, double,
   *     double, double)}.
