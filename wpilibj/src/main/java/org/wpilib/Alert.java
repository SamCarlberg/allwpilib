 ...
 * {@code kWarning}, or {@code kInfo} to denote urgency. See {@link Alert.AlertType AlertType} for
 * suggested usage of each type. Alerts can be displayed on supported dashboards, and are shown in a
 * priority order based on type and recency of activation, with newly activated alerts first.
 *
