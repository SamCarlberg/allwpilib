...
public interface LEDPattern {
   ...
   * AddressableLED.AddressableLEDBuffer} for the sake of code clarity.
   *
   * <pre><code>
   ...
   * using a {@link AddressableLED.AddressableLEDBufferView#reversed() reversed view} of the overall
   * buffer for that segment rather than reversing patterns.
   *
   * @return the reverse pattern
   * @see AddressableLED.AddressableLEDBufferView#reversed()
   */
