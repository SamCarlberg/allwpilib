...
import static org.wpilib.LEDPattern.GradientType.kContinuous;
import static org.wpilib.LEDPattern.GradientType.kDiscontinuous;
import static org.wpilib.color.Color.kBlack;
import static org.wpilib.color.Color.kBlue;
import static org.wpilib.color.Color.kGreen;
import static org.wpilib.color.Color.kLime;
import static org.wpilib.color.Color.kMagenta;
import static org.wpilib.color.Color.kMidnightBlue;
import static org.wpilib.color.Color.kPurple;
import static org.wpilib.color.Color.kRed;
import static org.wpilib.color.Color.kWhite;
import static org.wpilib.color.Color.kYellow;
...
class LEDPatternTest {
  ...
  void solidColor() {
    ...
    AddressableLED.AddressableLEDBuffer buffer = new AddressableLED.AddressableLEDBuffer(99);
  ...
  void discontinuousGradient3Colors() {
    ...
    AddressableLED.AddressableLEDBuffer buffer = new AddressableLED.AddressableLEDBuffer(101);
    pattern.applyTo(buffer);
  ...
  @Test
  void scrollForward() {
    var buffer = new AddressableLED.AddressableLEDBuffer(256);
  ...
  void rainbowAtFullSize() {
    var buffer = new AddressableLED.AddressableLEDBuffer(180);
  ...
  void rainbowAtHalfSize() {
    var buffer = new AddressableLED.AddressableLEDBuffer(90);
  ...
  void rainbowAtOneThirdSize() {
    var buffer = new AddressableLED.AddressableLEDBuffer(60);
  ...
  void rainbowAtDoubleSize() {
    var buffer = new AddressableLED.AddressableLEDBuffer(360);
  ...
  @Test
  void rainbowOddSize() {
    var buffer = new AddressableLED.AddressableLEDBuffer(127);
  ...
  @Test
  void reverseSteps() {
    var buffer = new AddressableLED.AddressableLEDBuffer(100);
  ...
  @Test
  void offsetPositive() {
    var buffer = new AddressableLED.AddressableLEDBuffer(21);
  ...
  void blinkSymmetric() {
    ...
    var buffer = new AddressableLED.AddressableLEDBuffer(1);
  ...
  void overlayMixed() {
    ...
    var buffer = new AddressableLED.AddressableLEDBuffer(2);
    overlay.applyTo(buffer);
  ...
  void binaryMask() {
    ...
    var buffer = new AddressableLED.AddressableLEDBuffer(10);
  ...
  void channelwiseMask() {
    ...
    var buffer = new AddressableLED.AddressableLEDBuffer(5);
    masked.applyTo(buffer);
  ...
  void reverseMask() {
    var pattern =
        LEDPattern.steps(Map.of(0, kRed, 0.25, kBlue, 0.5, kYellow, 0.75, kGreen))
            ...
            .reversed();
    var buffer = new AddressableLED.AddressableLEDBuffer(8);
