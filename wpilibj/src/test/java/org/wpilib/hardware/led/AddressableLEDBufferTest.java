...
class AddressableLEDBufferTest {
  ...
  @Test
  void getColorTest() {
    AddressableLED.AddressableLEDBuffer buffer = new AddressableLED.AddressableLEDBuffer(4);
  ...
  @Test
  void forEach() {
    var buffer = new AddressableLED.AddressableLEDBuffer(3);
  ...
  void forEachOnEmptyBuffer() {
    var buffer = new AddressableLED.AddressableLEDBuffer(0);
