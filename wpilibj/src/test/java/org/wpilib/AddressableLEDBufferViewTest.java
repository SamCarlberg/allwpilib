...
class AddressableLEDBufferViewTest {
  ...
  void singleLED() {
    ...
    var view = new AddressableLED.AddressableLEDBufferView(buffer, 5, 5);
  ...
  void segment() {
    var buffer = new AddressableLED.AddressableLEDBuffer(10);
    var view = new AddressableLED.AddressableLEDBufferView(buffer, 2, 8);
  ...
  void manualReversed() {
    var buffer = new AddressableLED.AddressableLEDBuffer(10);
    var view = new AddressableLED.AddressableLEDBufferView(buffer, 8, 2);
  ...
  void fullManualReversed() {
    var buffer = new AddressableLED.AddressableLEDBuffer(10);
    var view = new AddressableLED.AddressableLEDBufferView(buffer, 9, 0);
  ...
  void reversed() {
    var buffer = new AddressableLED.AddressableLEDBuffer(10);
    var view = new AddressableLED.AddressableLEDBufferView(buffer, 0, 9).reversed();
    view.setLED(0, Color.kWhite);
    assertEquals(Color.kWhite, buffer.getLED(9));
