...
public class LoggerGenerator {
   ...
   * class will subclass from {@link ClassSpecificLogger} and implement the {@code update()} method
   * to populate a data log with information from an instance of the data type.
   *
