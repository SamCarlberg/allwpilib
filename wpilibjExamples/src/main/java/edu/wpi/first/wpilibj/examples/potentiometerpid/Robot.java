...
public class Robot extends TimedRobot {
  ...
  static final Measure<Distance> kFullHeight = Meters.of(1.5);
  ...
  private final AnalogPotentiometer m_potentiometer =
      new AnalogPotentiometer(kPotChannel, kFullHeight.in(Meters));
  ...
  public void teleopInit() {
    ...
    m_index = 0;
    m_pidController.setSetpoint(kSetpoints[m_index].in(Meters));
  }
