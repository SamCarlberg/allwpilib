...
public class PerUnit<N extends Unit, D extends Unit> extends Unit {
   ...
   * method will always return a {@link Per} instance. If you want to avoid casting, use {@link
   * #ofNative(double)} that returns a {@code Per} instance directly.
   *
   ...
   * <p>Note: When called on an object of type {@code PerUnit} (and <i>not</i> a subclass!), this
   * method will always return a {@link Per} instance. If you want to avoid casting, use {@link
   * #ofNativeBaseUnits(double)} that returns a {@code Per} instance directly.
   *
   ...
   *
   * <p>Note: When called on an object of type {@code PerUnit} (and <i>not</i> a subclass!), this
   * method will always return a {@link MutPer} instance.
   *
