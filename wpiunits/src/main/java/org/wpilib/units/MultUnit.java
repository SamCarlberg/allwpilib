...
import org.wpilib.units.measure.ImmutableMult;
import org.wpilib.units.measure.Mult;
import org.wpilib.units.measure.MutMult;
...
public class MultUnit<A extends Unit, B extends Unit> extends Unit {
   ...
   * method will always return a {@link Mult} instance. If you want to avoid casting, use {@link
